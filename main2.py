...
frame = tk.Frame(root)
frame.place(relx=0.4, rely=0.05, relwidth=0.5, height=50)

upload_button = tk.Button(frame, text="Upload", bg="white", fg="black",font=('Arial', 12), command=upload_image)
upload_button.pack(side=tk.LEFT, padx=20, pady=10)

convert_button = tk.Button(frame, text="Convert to Grayscale", bg="white", fg="black", font=('Arial', 12), command=convert_to_grayscale)
